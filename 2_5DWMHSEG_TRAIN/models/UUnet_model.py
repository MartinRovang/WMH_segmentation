...
from monai.networks.blocks import  SimpleASPP, SEBlock
...
class UUNet(nn.Module):
    ...
    def __init__(self, in_channels=3, out_channels=1, init_features=64):
        ...
        # VGG19
        self.encoder1gg19 = SEBlock(spatial_dims = 2,
                                in_channels = in_channels,
                                n_chns_1 = features,
                                n_chns_2 = int(features // ratio),
                                n_chns_3 = features)
        
        self.encoder2gg19 = SEBlock(spatial_dims = 2,
                                in_channels = features,
                                n_chns_1 = features2,
                                n_chns_2 = int(features2 // ratio),
                                n_chns_3 = features2)

        self.encoder3gg19 = SEBlock(spatial_dims = 2,
                                in_channels = features2,
                                n_chns_1 = features3,
                                n_chns_2 = int(features3 // ratio),
                                n_chns_3 = features3)

        
        self.encoder4gg19 = SEBlock(spatial_dims = 2,
                                in_channels = features3,
                                n_chns_1 = features4,
                                n_chns_2 = int(features4 // ratio),
                                n_chns_3 = features4)
        ...
        self.bottleneckgg19 = SimpleASPP(
            2, features4, features4, kernel_sizes=[1, 3, 3, 3], dilations=[1, 2, 4, 6]
        )

        self.upconv4gg19 = nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True)
        
        self.dec4gg19 = SEBlock(spatial_dims = 2,
                                in_channels = features4 * 4 + features4,
                                n_chns_1 = features4,
                                n_chns_2 = int(features4 // ratio),
                                n_chns_3 = features4)
        ...
        self.dec3gg19 = SEBlock(spatial_dims = 2,
        ...
        self.dec2gg19 = SEBlock(spatial_dims = 2,
        ...
        self.dec1gg19 = SEBlock(spatial_dims = 2,
        ...
        # UNET
        self.encoder1U = SEBlock(spatial_dims = 2,
                                in_channels = in_channels,
                                n_chns_1 = features,
                                n_chns_2 = int(features // ratio),
                                n_chns_3 = features)
        
        self.encoder2U = SEBlock(spatial_dims = 2,
                                in_channels = features,
                                n_chns_1 = features2,
                                n_chns_2 = int(features2 // ratio),
                                n_chns_3 = features2)

        self.encoder3U = SEBlock(spatial_dims = 2,
                                in_channels = features2,
                                n_chns_1 = features3,
                                n_chns_2 = int(features3 // ratio),
                                n_chns_3 = features3)
        ...
        self.encoder4U = SEBlock(spatial_dims = 2,
                                in_channels = features3,
                                n_chns_1 = features4,
                                n_chns_2 = int(features4 // ratio),
                                n_chns_3 = features4)
        ...
        self.dec4U = SEBlock(spatial_dims = 2,
                                in_channels = features4 * 4 + features4*2 ,
                                n_chns_1 = features4,
                                n_chns_2 = int(features4 // ratio),
                                n_chns_3 = features4)
        ...
        self.dec3U = SEBlock(spatial_dims = 2,
        ...
        self.dec2U = SEBlock(spatial_dims = 2,
        ...
        self.dec1U = SEBlock(spatial_dims = 2,
                                in_channels = features2 + features*2,
                                n_chns_1 = features,
                                n_chns_2 = features // ratio,
                                n_chns_3 = features)
